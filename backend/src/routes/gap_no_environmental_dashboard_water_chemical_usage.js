...
// Batch 10 Gap: "No environmental dashboard (water / chemical usage)" (nonai-gap) for laundryServices
// Mount path: /api/gap-no-environmental-dashboard-water-chemical-usage
