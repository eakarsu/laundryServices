...
// Batch 10 frontend page: "No insurance / guarantee policies module" (nonai-gap) — laundryServices
import React, { useEffect, useState } from 'react';

const SLUG = "no-insurance-guarantee-policies-module";
const LABEL = "No insurance / guarantee policies module";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-insurance-guarantee-policies-module";

export default function GapNoInsuranceGuaranteePoliciesModule() {
