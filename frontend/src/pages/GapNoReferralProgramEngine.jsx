...
// Batch 10 frontend page: "No referral program engine" (nonai-gap) — laundryServices
import React, { useEffect, useState } from 'react';

const SLUG = "no-referral-program-engine";
const LABEL = "No referral program engine";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-referral-program-engine";

export default function GapNoReferralProgramEngine() {
