...
// Batch 10 frontend page: "No subscription personalization (preferences, schedule auto-tune)" (ai-gap) — laundryServices
import React, { useEffect, useState } from 'react';

const SLUG = "no-subscription-personalization-preferences-schedule-auto";
const LABEL = "No subscription personalization (preferences, schedule auto-tune)";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-subscription-personalization-preferences-schedule-auto";

export default function GapNoSubscriptionPersonalizationPreferencesScheduleAuto() {
